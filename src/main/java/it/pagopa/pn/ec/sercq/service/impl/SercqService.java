...
public class SercqService extends PresaInCaricoService implements QueueOperationsService {
    ...
    private final String receiverDigitalAddress;
    ...
    public SercqService(AuthService authService, AttachmentService attachmentService, GestoreRepositoryCall gestoreRepositoryCall, SqsService sqsService, PnEcConfig pnEcConfig) {
        super(authService);
        this.attachmentService = attachmentService;
        this.gestoreRepositoryCall = gestoreRepositoryCall;
        this.sqsService = sqsService;
        this.notificationTrackerSqsName = pnEcConfig.getNotificationTracker().getSqsQueue();
        this.receiverDigitalAddress = pnEcConfig.getSercq().getReceiverDigitalAddress();
    }
    ...
    public Mono<SendMessageResponse> sendNotificationOnStatusQueue(PresaInCaricoInfo presaInCaricoInfo, String status,
        ...
        return sqsService.send(notificationTrackerSqsName.getStatoSercqName(),
