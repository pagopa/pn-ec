...
public interface RequestMetadataService {
    ...
    Mono<RequestMetadata> getRequestMetadataByMessageIdKey(String messageId);
    Mono<RequestMetadata> setRequestMetadataMessageId(String concatRequest, MessageIdRequestMetadata messageIdToUpdate);
    Mono<RequestMetadata> updateRequestMetadataMessageId(String concatRequest, String messageId);
}
