...
public enum ConsAuditLogEventType {
    ...
    ERR_CONS("[ERR_CONS]"),
    ERR_CONS_BAD_STATUS_DATE_TIME("[ERR_CONS_BAD_STATUS_DATE_TIME]"),
    ERR_CONS_BAD_CLIENT_REQUEST_DATE_TIME("[ERR_CONS_BAD_CLIENT_REQUEST_DATE_TIME]"),
    ERR_CONS_BAD_CLIENT_REQUEST_TIMESTAMP("[ERR_CONS_BAD_CLIENT_REQUEST_TIMESTAMP]"),
    ...
    ERR_CONS_BAD_DOC_TYPE("[ERR_CONS_BAD_DOC_TYPE]"),
    ...
    ERR_CONS_DUPLICATED_EVENT ("[ERR_CONS_DUPLICATED_EVENT]");
