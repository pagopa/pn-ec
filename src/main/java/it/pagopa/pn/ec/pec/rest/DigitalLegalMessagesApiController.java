...
public class DigitalLegalMessagesApiController implements DigitalLegalMessagesApi {
    ...
    public DigitalLegalMessagesApiController(PecService pecService, StatusPullService statusPullService, TransactionProcessConfigurationProperties transactionProcessConfigurationProperties) {
    ...
    public Mono<ResponseEntity<Void>> sendDigitalLegalMessage(String requestIdx, String xPagopaExtchCxId, Mono<DigitalNotificationRequest> digitalNotificationRequest, final ServerWebExchange exchange) {
        return digitalNotificationRequest.doOnNext(request -> log.info("<-- Start presa in carico PEC-->"))
    ...
    public Mono<ResponseEntity<LegalMessageSentDetails>> getDigitalLegalMessageStatus(String requestIdx,
        ...
        return statusPullService.legalPullService(requestIdx, xPagopaExtchCxId , transactionProcessConfigurationProperties.pec())
