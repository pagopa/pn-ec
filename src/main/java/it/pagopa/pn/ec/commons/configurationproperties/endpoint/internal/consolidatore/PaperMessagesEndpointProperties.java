...
public record PaperMessagesEndpointProperties(String putRequest, String putDuplicateRequest, String getRequestProgress,
                                              String getDuplicateRequestProgress) {}
