...
public record GestoreRepositoryEndpointProperties(String basePath,

//                                                   <-- CLIENT CONFIGURATION -->
                                                  String getClientConfiguration, String postClientConfiguration,
                                                  String putClientConfiguration, String deleteClientConfiguration,
