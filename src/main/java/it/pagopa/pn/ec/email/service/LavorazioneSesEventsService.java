...
public class LavorazioneSesEventsService implements QueueOperationsService {
    ...
    public LavorazioneSesEventsService(GestoreRepositoryCall gestoreRepositoryCall, EmailService emailService, SqsService sqsService, SesService sesService,
                                       LogSanitizer logSanitizer, SqsTimeoutProvider sqsTimeoutProvider, PnEcConfig pnEcConfig,
    ...
    Mono<SendMessageResponse> lavorazioneSesEvents(SesNotificationDto sesNotificationDto, String queueName, Acknowledgement acknowledgement) {
        ...
        log.info("Start process {} for event {} into queue {}", LAVORAZIONE_SES_EVENT_EMAIL, sesNotificationDto.getNotificationType() != null ? sesNotificationDto.getNotificationType() : "unknown", emailSqsQueueName.getSesEventsName());
