...
//    public void lavorazioneRichiestaInteractive(final CartaceoPresaInCaricoInfo cartaceoPresaInCaricoInfo, final Acknowledgment
//    acknowledgment) {
        ...
        return gestoreRepositoryCall.getRichiesta(cartaceoPresaInCaricoInfo.getXPagopaExtchCxId(), cartaceoPresaInCaricoInfo.getRequestIdx()).flatMap(requestDto -> {
                                        ...
                                        return paperMessageCall.putRequest(paperEngageRequestDst).retryWhen(DEFAULT_RETRY_STRATEGY)
                                                               ...
                                                               .flatMap(operationResultCodeResponse -> sqsService.send(notificationTrackerSqsName.statoCartaceoName(),
                                                                                                                 ...
                                                                                                                 .onErrorResume(throwable -> sqsService.send(
