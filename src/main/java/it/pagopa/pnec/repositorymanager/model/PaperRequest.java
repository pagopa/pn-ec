...
public class PaperRequest {
	...
	public List<PaperEngageRequestAttachments> getAttachments() {
		return attachments;
	}
	public void setAttachments(List<PaperEngageRequestAttachments> attachments) {
	...
	public String toString() {
		return "PaperReq [iun=" + iun + ", requestPaid=" + requestPaid + ", productType=" + productType
