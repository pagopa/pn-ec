...
@Slf4j
public class LocalStackNewStartupStrategy {
    ...
    static LocalStackContainer localStackContainer =
            new LocalStackContainer(dockerImageName).withServices(SQS, DYNAMODB, SNS, SES, SECRETSMANAGER)
                    .withStartupTimeout(Duration.ofMinutes(2)).withEnv("AWS_DEFAULT_REGION", "eu-central-1").withCommand("sh", "-c", String.format("sleep 5 && echo \"%s\"", "Waiting for test container to be ready..."))
