...
import static it.pagopa.pn.ec.constant.QueueNameConstant.TEMP_QUEUE_NAME;
...
public class SQSLocalStackTestConfig {
    ...
    static {
        ...
        try {
            localStack.execInContainer("awslocal", "sqs", "create-queue", "--queue-name", TEMP_QUEUE_NAME);
