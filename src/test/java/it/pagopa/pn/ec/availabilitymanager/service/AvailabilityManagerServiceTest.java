...
class AvailabilityManagerServiceTest {
    ...
    void convertSafeStorageError() {
        ...
        when(requestConversionService.updateRequestConversion(dto.getDetail().getKey(), false, dto.getDetail().getChecksum(),true))
        ...
        verify(requestConversionService).updateRequestConversion(dto.getDetail().getKey(), false, dto.getDetail().getChecksum(),true);
